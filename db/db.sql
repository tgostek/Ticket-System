...
-- -----------------------------------------------------
-- Data for table `TICKET_SYSTEM`.`ACTION_TYPE`
-- -----------------------------------------------------
START TRANSACTION;
USE `TICKET_SYSTEM`;
INSERT INTO `TICKET_SYSTEM`.`ACTION_TYPE` (`TYP_ID`, `TYP_VALUE`, `TYP_COMUNICATE`) VALUES (1, 'ADDITION', 'ADDED');
INSERT INTO `TICKET_SYSTEM`.`ACTION_TYPE` (`TYP_ID`, `TYP_VALUE`, `TYP_COMUNICATE`) VALUES (2, 'STATUS', 'CHANGED STATUS');
INSERT INTO `TICKET_SYSTEM`.`ACTION_TYPE` (`TYP_ID`, `TYP_VALUE`, `TYP_COMUNICATE`) VALUES (3, 'QUEUE', 'CHANGED QUEUE');
INSERT INTO `TICKET_SYSTEM`.`ACTION_TYPE` (`TYP_ID`, `TYP_VALUE`, `TYP_COMUNICATE`) VALUES (4, 'PRIORITY', 'CHANGED PRIORITY');
INSERT INTO `TICKET_SYSTEM`.`ACTION_TYPE` (`TYP_ID`, `TYP_VALUE`, `TYP_COMUNICATE`) VALUES (5, 'REPIN', 'REPINNED USER');
INSERT INTO `TICKET_SYSTEM`.`ACTION_TYPE` (`TYP_ID`, `TYP_VALUE`, `TYP_COMUNICATE`) VALUES (6, 'COMMENT', 'COMMENTED');
