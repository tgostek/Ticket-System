...
CREATE SCHEMA IF NOT EXISTS `TICKET _SYSTEM` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci ;
USE `TICKET _SYSTEM` ;

-- -----------------------------------------------------
-- Table `TICKET _SYSTEM`.`USER_ROLE`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `TICKET _SYSTEM`.`USER_ROLE` (
...
-- -----------------------------------------------------
-- Table `TICKET _SYSTEM`.`USER`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `TICKET _SYSTEM`.`USER` (
  ...
  CONSTRAINT `fk_USER_USER_ROLE1`
    ...
    REFERENCES `TICKET _SYSTEM`.`USER_ROLE` (`ROL_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `TICKET _SYSTEM`.`STATUS`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `TICKET _SYSTEM`.`STATUS` (
...
-- -----------------------------------------------------
-- Table `TICKET _SYSTEM`.`PRIORITY`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `TICKET _SYSTEM`.`PRIORITY` (
...
-- -----------------------------------------------------
-- Table `TICKET _SYSTEM`.`QUEUE`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `TICKET _SYSTEM`.`QUEUE` (
...
-- -----------------------------------------------------
-- Table `TICKET _SYSTEM`.`TICKET`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `TICKET _SYSTEM`.`TICKET` (
  ...
  CONSTRAINT `fk_TICKET_USER`
    ...
    REFERENCES `TICKET _SYSTEM`.`USER` (`USR_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  ...
  CONSTRAINT `fk_TICKET_STATUS1`
    ...
    REFERENCES `TICKET _SYSTEM`.`STATUS` (`STS_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_TICKET_PRIORITY1`
    FOREIGN KEY (`PRT_TCK_PRIORITY`)
    REFERENCES `TICKET _SYSTEM`.`PRIORITY` (`PRT_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_TICKET_QUEUE1`
    FOREIGN KEY (`QUE_QUEUE`)
    REFERENCES `TICKET _SYSTEM`.`QUEUE` (`QUE_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `TICKET _SYSTEM`.`COMMENT`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `TICKET _SYSTEM`.`COMMENT` (
  ...
  CONSTRAINT `fk_COMMENT_TICKET1`
    ...
    REFERENCES `TICKET _SYSTEM`.`TICKET` (`TCK_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `TICKET _SYSTEM`.`ATTACHMENT`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `TICKET _SYSTEM`.`ATTACHMENT` (
...
-- -----------------------------------------------------
-- Table `TICKET _SYSTEM`.`TICKET_has_ATTACHMENT`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `TICKET _SYSTEM`.`TICKET_has_ATTACHMENT` (
  ...
  CONSTRAINT `fk_TICKET_has_ATTACHMENT_ATTACHMENT1`
    ...
    REFERENCES `TICKET _SYSTEM`.`ATTACHMENT` (`ATT_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `TICKET _SYSTEM`.`COMMENT_has_ATTACHMENT`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `TICKET _SYSTEM`.`COMMENT_has_ATTACHMENT` (
  ...
  CONSTRAINT `fk_COMMENT_has_ATTACHMENT_COMMENT1`
    ...
    REFERENCES `TICKET _SYSTEM`.`COMMENT` (`CMT_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `TICKET _SYSTEM`.`ACTION_TYPE`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `TICKET _SYSTEM`.`ACTION_TYPE` (
...
-- -----------------------------------------------------
-- Table `TICKET _SYSTEM`.`ACTION_FLOW`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `TICKET _SYSTEM`.`ACTION_FLOW` (
  ...
  CONSTRAINT `fk_ACTION_FLOW_ACTION_TYPE1`
    ...
    REFERENCES `TICKET _SYSTEM`.`ACTION_TYPE` (`TYP_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
